...
<template>
  ...
  >
    <div class="space-y-4">
      ...
      <!-- Add form -->
      <div v-if="isMaster()" class="rounded-lg border border-border bg-muted/30 p-3 space-y-2">
        <div class="flex items-center gap-1">
          <button
            ...
            :class="[
              ...
              newKind === 'ip' ? 'bg-background text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'
            ]"
          >
          ...
          <button
            ...
            :class="[
              'inline-flex items-center gap-1.5 h-7 rounded-md px-2.5 text-xs font-medium transition-colors',
              newKind === 'domain' ? 'bg-background text-foreground shadow-sm' : 'text-muted-foreground hover:text-foreground'
            ]"
          >
            <Globe :size="13" /> Домен
          </button>
